...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitStatus({
        type: 'error',
        message: 'Impossible de soumettre votre demande. Vérifiez votre connexion internet.'
      });
    } finally {
      ...
      <section id="accueil" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-blue-700 to-blue-600 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          ...
          <p className="text-xl md:text-2xl mb-8 text-blue-100 animate-fade-in-up animation-delay-200">
            L&apos;excellence du lavage automobile à votre service
          </p>
          <p className="text-lg md:text-xl mb-12 max-w-3xl mx-auto text-blue-50 animate-fade-in-up animation-delay-400">
            Profitez d&apos;un service professionnel de lavage auto avec des produits premium.
            Votre véhicule mérite le meilleur traitement.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up animation-delay-600">
            <a
              href="#services"
              className="bg-white text-blue-600 px-8 py-4 rounded-full font-semibold hover:bg-blue-50 transition-all hover:scale-105 shadow-lg"
            >
              Découvrir nos services
            </a>
            <a
              href="#contact"
              className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-blue-600 transition-all hover:scale-105"
            >
              Nous contacter
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Des prestations complètes pour prendre soin de votre véhicule
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Service 1 */}
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all hover:-translate-y-2 group">
              ...
              <p className="text-gray-600 mb-4">
                Lavage complet de la carrosserie, jantes et pneus avec des produits professionnels de haute qualité.
              </p>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all hover:-translate-y-2 group">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Lavage Intérieur</h3>
              <p className="text-gray-600 mb-4">
                Nettoyage complet de l&apos;habitacle pour un intérieur impeccable et parfumé.
              </p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all hover:-translate-y-2 group">
              ...
              <p className="text-gray-600 mb-4">
                La formule complète alliant lavage extérieur et intérieur pour une propreté totale.
              </p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all hover:-translate-y-2 group">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Polissage</h3>
              <p className="text-gray-600 mb-4">
                Redonnez de l&apos;éclat à votre peinture avec notre service de polissage professionnel.
              </p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all hover:-translate-y-2 group">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Protection Céramique</h3>
              <p className="text-gray-600 mb-4">
                Protection longue durée pour votre carrosserie contre les agressions extérieures.
              </p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center">
            ...
            {/* Service 6 */}
            <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all hover:-translate-y-2 group">
              <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-indigo-700 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Rénovation Phares</h3>
              <p className="text-gray-600 mb-4">
                Redonnez transparence et éclat à vos phares ternis par le temps.
              </p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center">
      ...
      <section id="tarifs" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Des prix transparents et compétitifs pour tous nos services
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Basic Plan */}
            <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-gray-200 hover:border-blue-500 transition-all hover:-translate-y-2">
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Formule Essentielle</h3>
                <div className="flex items-center justify-center mb-4">
                  <span className="text-5xl font-bold text-gray-900">25€</span>
                </div>
                <p className="text-gray-600">Parfait pour un entretien régulier</p>
              </div>
            ...
            {/* Premium Plan */}
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl shadow-2xl p-8 border-2 border-blue-600 transform scale-105 relative">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-blue-100">La formule la plus complète</p>
              </div>
              <ul className="space-y-4 mb-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-gray-200 hover:border-blue-500 transition-all hover:-translate-y-2">
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Formule VIP</h3>
                <div className="flex items-center justify-center mb-4">
                  <span className="text-5xl font-bold text-gray-900">75€</span>
                </div>
                <p className="text-gray-600">Le luxe pour votre véhicule</p>
              </div>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center text-gray-700">
                  <svg className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section id="contact" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Réservez votre prestation ou demandez un devis personnalisé
            </p>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-800 text-white px-8 py-4 rounded-full font-semibold hover:shadow-lg hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                >
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100">Marseille, France</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100">+33 X XX XX XX XX</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100">contact@royalwashpro.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100">Lun - Sam: 8h - 19h</p>
                      <p className="text-blue-100">Dimanche: 9h - 17h</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Une équipe formée et expérimentée</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-blue-600 mr-3 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Produits Premium</h4>
                      <p className="text-gray-600">Nous utilisons les meilleurs produits du marché</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-blue-600 mr-3 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
